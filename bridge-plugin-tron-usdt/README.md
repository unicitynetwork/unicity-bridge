...
See the design docs:
- [`../docs/bridge/MINT_REASON.md`](../docs/bridge/MINT_REASON.md) — proof format + verification rule
- [`../docs/bridge/PLUGIN_ARCHITECTURE.md`](../docs/bridge/PLUGIN_ARCHITECTURE.md) — how plugins plug in
- [`../docs/bridge/BRIDGE_BACK.md`](../docs/bridge/BRIDGE_BACK.md) — returning to Tron (design)
...
```bash
npm install      # links ../state-transition-sdk-js via file:
npm run typecheck
