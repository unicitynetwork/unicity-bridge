...
**Reference spec:** [`../spec/ZK_BACK3.md`](../spec/ZK_BACK3.md) is the engineering source of
...
[`../../protocol/interop.md`](../../protocol/interop.md).

This README is the map. The detail lives in four sibling documents:

| Doc | Owns | Stack |
|---|---|---|
| [`../../protocol/interop.md`](../../protocol/interop.md) | The frozen byte-level contract every component must obey, + the conformance-vector mechanism | spec + fixtures |
...
[`../../protocol/interop.md`](../../protocol/interop.md), and it is frozen **before**
...
1. **One normative spec** — `protocol/interop.md`. No component invents an
...
2. **Cross-stack conformance vectors** — a versioned `protocol/vectors/` fixture set
   ...
   See `protocol/interop.md` §"Conformance vectors".
...
- **`docs/spec/`** —  `ZK_BACK3.md`, `MINT_REASON.md`,
  `PLUGIN_ARCHITECTURE.md`, `TRUST_MODELS.md`.

## Decisions (fixed)

Resolved in `protocol/interop.md`; recorded here so they are not lost:
