...
message rewrite (one-line messages, per the repo CLAUDE.md); earlier hashes
in older notes map onto these.
...
|---|---|---|---|---|---|
| `docs/bridging-analysis` | `18336df` | 2026-09-18 | analysis | `BRIDGING_ANALYSIS.md` (theory, trust list, demo divergences, prover soundness problem, actors chapter with connection map) and `docs/dev-plan/09-testnet-e2e.md` (findings, URLs, dependency-ordered plan). | no |
