...
import { TronLinkSigner, type TronLinkWindow } from './signer.js';
...
export function walletConnectProvider(factory: WalletConnectSignerFactory): SourceWalletProvider {
  return {
    id: 'walletconnect',
    name: 'WalletConnect',
 ...
 */
export function availableTronWallets(config: TronWalletConfig = {}): SourceWalletProvider[] {
  const providers: SourceWalletProvider[] = [tronLinkProvider()];
