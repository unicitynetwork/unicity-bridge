...
{
  echo "ETH_SK=${ETH_SK:-}"
  echo "ETH_VAULT=${ETH_VAULT:-}"
  echo "ETH_VAULT_DEPLOY_BLOCK=${ETH_VAULT_DEPLOY_BLOCK:-0}"
  echo "ETH_RPC_URL=${ETH_RPC_URL:-https://ethereum-sepolia-rpc.publicnode.com}"
  echo "ETH_CHAIN_ID=${ETH_CHAIN_ID:-11155111}"
